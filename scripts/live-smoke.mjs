...
assert(publishSrc.includes('canHostUploads'), 'video publish prefers hosted upload when available')
...
assert(picsPublishSrc.includes('storeMediaBlob'), 'photo publish can finish upload if host is unavailable')
