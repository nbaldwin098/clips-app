...
assert(publishSrc.includes('Never persist ephemeral blob'), 'uploads never persist blob: URLs')
assert(publishSrc.includes('localStored'), 'uploads mark IndexedDB storage')
