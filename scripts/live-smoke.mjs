...
assert(namedAct2.includes('namedBotsAllowedHere'), 'named bots do not run on every visitor')
assert(namedAct2.includes('setInterval'), 'named bots still have a tick loop for local testing')
