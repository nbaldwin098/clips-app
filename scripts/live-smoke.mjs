...
assert(!adUnitsSrc.includes('InFeedAd'), 'unused in-feed ad component removed')
...
assert(exoSrc.includes('BANNER_FILL_TIMEOUT_MS'), 'clip banners wait longer for a fill than in-feed slides')
