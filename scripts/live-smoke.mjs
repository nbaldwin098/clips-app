...
assert(watchSrcPre.includes('onPlaying={countViewOnPlay}'), 'watch counts a view when playback starts')
assert(!watchSrcPre.includes('setViews(recordView(item.id))'), 'watch does not count views on page load')
