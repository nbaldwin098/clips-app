...
assert(stageSrc.includes('PRELOAD_NEAR = 2'), 'clip and pic players keep the next slides mounted')
...
assert(shortsFeedSrc.includes('bottom-44'), 'clip tap layer does not cover banner ads')
