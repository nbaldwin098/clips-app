...
assert(shortsFeedSrc.includes('getById(focusId)'), 'clips from a profile still open that clip')
...
assert(cadenceSrc.includes("format: 'video'"), 'clip in-feed ads are VAST video, not a blank display zone')
assert(cadenceSrc.includes("format: 'banner'"), 'pic in-feed ads are display banners')
...
assert(adUnitsSrc.includes('FeedVideoAd'), 'clip cards play a VAST feed ad')
assert(adUnitsSrc.includes('ExoClickDisplay'), 'pic cards use the display unit at native size')
...
assert(shortsFeedSrc.includes('FeedVideoAd'), 'clip player plays VAST between clips')
...
assert(shortsFeedSrc.includes('FeedVideoAd'), 'clip player ads use the VAST feed component')
