...
assert(adminSrc.includes("['setup', 'Setup']"), 'admin has a setup tab for sql')
...
assert(adminSrc.includes('id-checks'), 'admin has ID checks tab')
assert(adminSrc.includes('Accept') && adminSrc.includes('Deny'), 'admin can accept or deny ID')
assert(adminSrc.includes('setIdVerificationStatus'), 'admin writes ID review')
