...
assert(adUnitsSrc.includes("variant === 'pic'"), 'pic mosaic ads use a square photo tile')
assert(adUnitsSrc.includes('aspect-square'), 'pic ads match photo size')
assert(adUnitsSrc.includes('ExoClickDisplay'), 'clip and pic cards share the display unit at native size')
...
assert(picsPageSrc.includes('variant="pic"'), 'pics mosaic uses square pic ad tiles')
...
assert(analyticsSrc.includes('Overview'), 'creator analytics has an overview portal')
assert(analyticsSrc.includes('Reach by post'), 'creator analytics charts real post views')
assert(analyticsSrc.includes('<table'), 'creator analytics has a posts table')
assert(!/youtube|studio.google|impressions ctr/i.test(analyticsSrc), 'creator analytics is not a YouTube Studio clone')
