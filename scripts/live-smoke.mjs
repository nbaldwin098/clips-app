...
const dashStudioSrc = readFileSync(new URL('../src/components/CreatorDashboard.jsx', import.meta.url), 'utf8')
assert(dashStudioSrc.includes('CREATOR_STUDIO_GROUPS'), 'creator dashboard uses studio catalog nav')
...
const dashSrc2 = readFileSync(new URL('../src/components/CreatorDashboard.jsx', import.meta.url), 'utf8')
assert(dashSrc2.includes('{approved ?'), 'creator dashboard hides money until approved')
...
const dashSrcPosts = readFileSync(new URL('../src/components/CreatorDashboard.jsx', import.meta.url), 'utf8')
