...
const CLIENT_ENV = {
  ...
  VITE_OAUTH_INSTAGRAM_CLIENT_ID: (typeof process !== 'undefined' && process.env.VITE_OAUTH_INSTAGRAM_CLIENT_ID) || '',
  VITE_OAUTH_X_CLIENT_ID: (typeof process !== 'undefined' && process.env.VITE_OAUTH_X_CLIENT_ID) || '',
  VITE_OAUTH_FACEBOOK_CLIENT_ID: (typeof process !== 'undefined' && process.env.VITE_OAUTH_FACEBOOK_CLIENT_ID) || '',
