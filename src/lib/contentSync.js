...
/**
 * Single-row fetch for watch / delete.
 * Do not call get_video_by_id until 0028 is applied on the live project —
 * the RPC 404s and the videos table select already succeeds.
 */
