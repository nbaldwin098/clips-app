...
export const PROMO_PRESETS = [
  {
    ...
    body: 'Watch videos, short videos, and pics. Upload from the + button.',
  ...
  {
    id: 'creator-apps',
    name: 'Anyone can post',
    headline: 'Anyone with an account can post',
    body: 'Upload, Studio, and the live lobby are open. There is no application.',
  ...
  },
  {
    ...
    body: 'Start a listing from + → Go live.',
    ctaLabel: 'Open Live',
    destView: 'live',
    destId: '',
    featureContentId: '',
  ...
  {
    id: 'clips-pics',
    name: 'Short videos + Pics',
    headline: 'Short videos and Pics',
  ...
  },
  {
    id: 'subscribed',
    name: 'Subscribed',
    headline: 'Subscribe to creators',
    body: 'See their uploads on Subscribed.',
    ctaLabel: 'Subscribed',
  ...
  },
  {
    ...
    body: 'Paid posts when Stripe is connected. Subscribe stays free.',
    ctaLabel: 'Membership',
    destView: 'checkout',
    destId: '',
    featureContentId: '',
