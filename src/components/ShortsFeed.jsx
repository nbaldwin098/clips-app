  ...
  return (
    <ShortsStage
      ...
      renderSlide={(index, active, warm) => {
        ...
        if (row?.kind === 'ad') {
          return (
            <ClipFeedAdSlide active={active} ad={row.ad} onEmpty={() => skipAdSlide(index)} />
          )
        }
        return row?.item ? (
          <ClipSlide
            ...
            showBanner={active && (bannerSlide === index || clipBannerAllowed(visibleMixed, index))}
          />
        ) : null
      }}
    />
