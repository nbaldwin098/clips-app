...
export default function CreatorDashboard({ onOpenImport }) {
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500 leading-relaxed">
              Paste a TikTok, YouTube Shorts, or Instagram Reels link. We store only metadata and the reference URL — no binary upload. Cross-post detection runs automatically.
            </p>
          </div>
        </button>
        ...
        <div className="flex items-start gap-4 p-5 rounded-2xl border border-slate-200/80 bg-white">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500 leading-relaxed">
              Optional path: client-side compression to 720p vertical before any network request. Prefer Import for zero storage cost.
            </p>
          </div>
        </div>
