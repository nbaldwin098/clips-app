...
/**
 * Sound library + "add your own" picker, embedded directly in the video/clip
 * create flow (the "+" button) instead of living as its own sidebar page —
 * sounds only ever matter in the context of something you're publishing.
 */
export default function SoundPicker({ value, onChange, onOpenAuth }) {
  ...
  return (
    <div>
      <p className="text-xs text-zinc-400 mb-1.5">Sound (optional)</p>
      {value ? (
