        ...
        <ul className="space-y-2">
          {SOCIAL_PROVIDERS.map((p) => {
            ...
            return (
              <li
                key={p.id}
                className="flex flex-wrap items-center gap-3 border border-white/10 px-3 py-2 rounded-lg"
              >
                <span className={cn(
                  'h-9 w-9 inline-flex items-center justify-center border',
                  on ? 'border-white bg-white text-black' : 'border-white/15 text-zinc-400'
                )}
                >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {on ? (
                    ...
                    <input
                      ...
                      placeholder="@handle"
                      className="mt-1 h-8 w-full max-w-[12rem] border border-white/15 bg-[#0f0f0f] px-2 text-xs text-white"
                ...
                <button
                  ...
                  className="h-8 px-3 text-xs font-semibold border border-white/15 text-zinc-200 hover:border-white"
                >
