    ...
    <div className="p-4 md:p-6 max-w-lg mx-auto">
      ...
      <div className="rounded-xl border border-[#2f2f37] bg-[#1f1f23] p-5 space-y-4">
        <label className="block text-xs text-white">
          Quality
          <select value={quality} onChange={(e) => setQuality(e.target.value)} className="mt-1 w-full h-10 rounded-lg border border-[#2f2f37] bg-[#000000] px-2 text-sm text-zinc-100">
        ...
        <label className="block text-xs text-white">
          Latency
          <select value={latency} onChange={(e) => setLatency(e.target.value)} className="mt-1 w-full h-10 rounded-lg border border-[#2f2f37] bg-[#000000] px-2 text-sm text-zinc-100">
