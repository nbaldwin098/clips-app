...
export default function SettingsLayout({ section, onSection, children }) {
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)]">
      <aside className="hidden lg:flex w-56 shrink-0 flex-col border-r border-slate-200 bg-white p-3">
        <p className="px-3 mb-2 text-xs font-semibold uppercase tracking-wider text-slate-400">Settings</p>
