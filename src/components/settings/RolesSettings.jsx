  ...
  return (
    <div className="space-y-8">
      ...
      <section className="pt-6 border-t border-zinc-800 space-y-3">
        ...
        <p className="text-xs text-zinc-500">Viewers can type !rules in live chat. Creators and mods can type !ad to run a mid-stream ad, with at least 5 minutes between breaks. Mods can timeout, ban, and delete messages in chat.</p>
        <textarea
          value={staff.rules || ''}
          onChange={(e) => {
