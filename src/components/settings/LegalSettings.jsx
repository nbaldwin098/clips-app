  ...
  return (
    <div className="space-y-8 text-zinc-200">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500">Public policies and how to reach {ORG.productName}.</p>
      </div>
      ...
      <p className="text-xs text-zinc-500">
        Export and clear this device from Settings → Security. Email is stored with your {ORG.productName} account when you signed in with email.
      </p>
    </div>
  )
}
