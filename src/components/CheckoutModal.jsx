  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70" role="dialog" aria-modal="true">
      <div className="w-full max-w-sm rounded-2xl border border-zinc-800 bg-[#121218] shadow-2xl p-5 relative">
        ...
        <p className="mt-4 text-3xl font-semibold text-[#007ACC]">
        ...
        {already ? (
          ...
          <button type="button" disabled={busy || !isAuthenticated} onClick={pay} className="mt-5 w-full h-11 rounded-xl bg-[#007ACC] text-white text-sm font-medium disabled:opacity-40">
