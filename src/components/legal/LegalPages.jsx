...
export function TermsOfService() {
  return (
    <LegalShell title="Terms of Service">
      ...
      <h2>1. Acceptance</h2>
      <p>By accessing or using {ORG.productName} you agree to these Terms. If you do not agree, do not use the service.</p>
      <h2>2. Accounts</h2>
      ...
      <h2>3. Content</h2>
      <p>You retain ownership of content you upload. You grant {ORG.productName} a limited license to host, transcode, and distribute that content on the service. You represent you have all rights needed to post it.</p>
      ...
      <h2>5. Copyright</h2>
      <p>{ORG.productName} operates a notice-and-takedown process under the DMCA. See Settings → Copyright &amp; DMCA for intake addresses, strike policy, and counter-notification procedures.</p>
      ...
      <h2>7. Disclaimers</h2>
      <p>The service is provided “as is.” To the fullest extent permitted by law, {ORG.productName} disclaims warranties of merchantability, fitness for a particular purpose, and non-infringement.</p>
      <h2>8. Limitation of liability</h2>
      <p>To the fullest extent permitted by law, {ORG.productName} is not liable for indirect, incidental, special, or consequential damages arising from use of the service.</p>
      <h2>9. Changes</h2>
...
export function PrivacyPolicy() {
  return (
    <LegalShell title="Privacy Policy">
      ...
      <h2>3. Storage</h2>
      <p>Sessions and taste may be stored in your browser. Signed-in accounts also sync through {ORG.productName}. We do not sell personal data.</p>
      <h2>4. Sharing</h2>
...
export function CreatorAgreement() {
  return (
    <LegalShell title="Creator Agreement">
      ...
      <p>You grant {ORG.productName} a non-exclusive license to host and deliver your content on the service.</p>
      <h2>4. Taxes</h2>
