...
- [ ] Wire recordInteraction into player events
...
## F. Live
- [x] Stream key UI
- [ ] Live player, chat, widgets (shells next)

## G–L
See prior sections. Backend-dependent items remain open until infrastructure is funded.
